    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递公司" prop="goodsOrderCourierName">
                       <el-input v-model="ruleForm.goodsOrderCourierName"
                                 placeholder="快递公司" clearable  :readonly="ro.goodsOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="快递公司" prop="goodsOrderCourierName">
                           <el-input v-model="ruleForm.goodsOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递单号" prop="goodsOrderCourierNumber">
                       <el-input v-model="ruleForm.goodsOrderCourierNumber"
                                 placeholder="快递单号" clearable  :readonly="ro.goodsOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="快递单号" prop="goodsOrderCourierNumber">
                           <el-input v-model="ruleForm.goodsOrderCourierNumber"
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    goodsOrderCourierName: false,
                    goodsOrderCourierNumber: false,
                ...
                ruleForm: {
                    ...
                    goodsOrderTruePrice: '',
                    goodsOrderTypes: '',
                    goodsOrderCourierName: '',
                    goodsOrderCourierNumber: '',
